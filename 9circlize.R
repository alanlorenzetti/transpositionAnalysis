...
col=adjustcolor(defaultPal[4],alpha.f = 0.5)
...
bed1=data.frame(chr=chr1,start=start1,end=end1)
bed2=data.frame(chr=chr2,start=start2,end=end2)
col=adjustcolor(defaultPal[1],alpha.f = 0.5)
circos.genomicLink(bed1, bed2, col = col)
...
isfamilies=c("Other_Families", "ISH3", "IS4")
...
circos.genomicTrackPlotRegion(bed_list, ylim = c(0,1), track.height=0.05, bg.col = adjustcolor("white", alpha.f = 0.9),
                              panel.fun = function(region, value, ...) {
                                i=getI(...)
                                circos.genomicRect(region, value, col = defaultPal[i])
                              }
)

# initializing and plotting arrows
circos.arrow(sector.index = pnrc100, track.index = 2, x1 = 0, x2 = 112795, col = defaultPal[4])
circos.arrow(sector.index = pnrc100, track.index = 2, x1 = 158783, x2 = 191345, col = defaultPal[4])
circos.arrow(sector.index = pnrc200, track.index = 2, x1 = 0, x2 = 112795, col = defaultPal[4])
circos.arrow(sector.index = pnrc200, track.index = 2, x1 = 332793, x2 = 365424, col = defaultPal[4])

circos.arrow(sector.index = pnrc100, track.index = 2, x1 = 32041, x2 = 71210, arrow.position = "start", col = defaultPal[1])
circos.arrow(sector.index = pnrc100, track.index = 2, x1 = 150252, x2 = 191345, col = defaultPal[1])
circos.arrow(sector.index = pnrc200, track.index = 2, x1 = 332793, x2 = 365424, col = defaultPal[1])
circos.arrow(sector.index = pnrc200, track.index = 2, x1 = 32041, x2 = 64674, arrow.position = "start", col = defaultPal[1])
...
gc = read.delim(file = "gccontent.bedgraph", header=F)
if(genomewidegc == "y"){
  mingc=min(gc$V4)
  maxgc=max(gc$V4)
  meangc=mean(gc$V4)
...
for(i in barcodes){
  df1 = read.delim(paste0(i,"_500bp.bedgraph"), header=F, na.strings = ".")
...
circos.genomicTrackPlotRegion(bed_list, track.height=0.15, bg.col=color,
                                panel.fun = function(region, value, ...) {
                                  i = getI(...)
                                  color = adjustcolor(defaultPal[i],alpha.f = 0.5)
...
circos.genomicTrackPlotRegion(bed_list, track.height=0.15, bg.col=color,
                              panel.fun = function(region, value, ...) {
                                i = getI(...)
                                color = adjustcolor(defaultPal[i],alpha.f = 1)
...
circos.genomicTrackPlotRegion(bed_list, ylim = c(0,1), track.height=0.05, bg.col = adjustcolor("white", alpha.f = 0.9),
                              panel.fun = function(region, value, ...) {
                                i=getI(...)
                                circos.genomicRect(region, value, col = defaultPal[i], lwd = 0.15)
                              }
)
